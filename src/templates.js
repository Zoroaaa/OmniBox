...
<head>
  ...
  <title>OmniBox - Web Proxy</title>
  <meta name="description" content="OmniBox - Secure, fast, modern web proxy service">
  <meta name="keywords" content="proxy, web proxy, cloudflare worker, omnibox, secure browsing">
  <style>
    ${commonStyles}
    ${mainPageStyles}
  </style>
...
<body>
  <div class="container">
    <div class="header">
      <h1>OmniBox</h1>
      <p class="subtitle">Universal Web Proxy Service</p>
    ...
    <div class="footer">
      <p>OmniBox Proxy Worker v${CONFIG.VERSION}</p>
    </div>
  </div>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Access Authentication - OmniBox</title>
  <meta name="description" content="Secure access to OmniBox proxy service">
  <style>
    ${commonStyles}
    ${passwordPageStyles}
  </style>
  ...
  <div class="container">
    <div class="glass-card password-container">
      <div class="header">
        ...
        <p class="subtitle">Please enter the access password to continue using OmniBox</p>
